---
name: unity-simple-mcp-run-parsetests
description: Parse saved Unity test logs and NUnit XML through unity.sh parse-tests without launching Unity. Use to inspect test failures, validate existing artifacts, or enforce skipped-test policy instead of rerunning tests.
---
...
Task: Unity MCP: Parse test results

## Manual usage

Choose **Terminal > Run Task > Unity MCP: Parse test results**, or run:
