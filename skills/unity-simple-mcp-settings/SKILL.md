---
name: unity-simple-mcp-settings
description: Open and edit the project's Unity and Rider/MSBuild tool settings. Use for custom installations, tool-path overrides, or selecting a solution without launching Unity or changing project setup.
---
...
Task: Unity MCP: Open tool settings

## Manual usage

Choose **Terminal > Run Task > Unity MCP: Open tool settings**, or run:
...
Use **Unity MCP: Check tool paths** when path validation is wanted; it resolves the
