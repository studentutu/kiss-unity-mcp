---
name: unity-simple-mcp-import
description: Run authoritative headless Unity import and C# compilation, regenerate IDE solution files, and refresh the fast-build snapshot. Use after setup or changes to files, assets, asmdefs, packages, settings, or Unity editor behavior.
---
...
Task: Unity MCP: Import and generate solution (long-compile)
...
VS Code: **Unity MCP: Import and generate solution (long-compile)**.
MCP: `unity_import` with absolute `project_path`.
