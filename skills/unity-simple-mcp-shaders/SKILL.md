---
name: unity-simple-mcp-shaders
description: Reimport project shaders and verify Unity shader diagnostics headlessly. Use after shader changes or to investigate shader/import errors; this does not prove every player-build platform and keyword variant compiles.
---
...
Task: Unity MCP: Compile shaders
...
VS Code: **Unity MCP: Compile shaders**. MCP: `unity_shaders` with absolute
`project_path`.
